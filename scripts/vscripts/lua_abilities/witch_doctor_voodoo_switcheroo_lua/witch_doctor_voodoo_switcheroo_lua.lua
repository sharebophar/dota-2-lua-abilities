...
LinkLuaModifier( "modifier_witch_doctor_voodoo_switcheroo_lua", "lua_abilities/witch_doctor_voodoo_switcheroo_lua/modifier_witch_doctor_voodoo_switcheroo_lua", LUA_MODIFIER_MOTION_NONE )
...
function witch_doctor_voodoo_switcheroo_lua:OnSpellStart()
    ...
    -- 给自己加一个隐藏效果，并在原地创建一个死亡守卫
    caster:AddNewModifier(
		self:GetCaster(), -- player source
		self, -- ability source
		"modifier_witch_doctor_voodoo_switcheroo_lua", -- modifier name
		{
...
function witch_doctor_voodoo_switcheroo_lua:AbilityConsiderations()
	-- Scepter
...
--------------------------------------------------------------------------------
-- Projectile 特效击中事件
function witch_doctor_voodoo_switcheroo_lua:OnProjectileHit_ExtraData( target, location, kv )
...
-- Graphics & Effects
-- 播放追踪特效
function witch_doctor_voodoo_switcheroo_lua:PlayProjectile( info )
...
function witch_doctor_voodoo_switcheroo_lua:StopProjectile( kv )
