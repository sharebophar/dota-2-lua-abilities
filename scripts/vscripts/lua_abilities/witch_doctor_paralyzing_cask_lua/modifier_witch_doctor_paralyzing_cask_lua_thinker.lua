modifier_witch_doctor_paralyzing_cask_lua_thinker = class({})
local tempTable = require( "util/tempTable" )

--------------------------------------------------------------------------------
-- Classifications
function modifier_witch_doctor_paralyzing_cask_lua_thinker:IsHidden()
	return false
end

function modifier_witch_doctor_paralyzing_cask_lua_thinker:IsPurgable()
	return false
end

function modifier_witch_doctor_paralyzing_cask_lua_thinker:RemoveOnDeath()
	return false
end

function modifier_witch_doctor_paralyzing_cask_lua_thinker:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end

--------------------------------------------------------------------------------
-- Initializations
function modifier_witch_doctor_paralyzing_cask_lua_thinker:OnCreated( kv )
	if IsServer() then
		self.key = kv.key
	end
end

function modifier_witch_doctor_paralyzing_cask_lua_thinker:OnRefresh( kv )
	
end

function modifier_witch_doctor_paralyzing_cask_lua_thinker:OnDestroy( kv )
	if IsServer() then
...
--------------------------------------------------------------------------------
-- Graphics & Effects
function modifier_witch_doctor_paralyzing_cask_lua_thinker:PlayProjectile( info )
