...
local PrismaticParticles = {
    ["particles/units/heroes/hero_terrorblade/terrorblade_ambient_sword_l.vpcf"]= 1,
    ["particles/units/heroes/hero_terrorblade/terrorblade_ambient_sword_r.vpcf"]= 1,
    ["particles/units/heroes/hero_terrorblade/terrorblade_ambient_sword_blade.vpcf"]= 1,
    ["particles/units/heroes/hero_terrorblade/terrorblade_ambient_sword_blade_2.vpcf"]= 1,
    ["particles/units/heroes/hero_terrorblade/terrorblade_ambient_eyes.vpcf"]= 1,
    ["particles/units/heroes/hero_terrorblade/terrorblade_feet_effects.vpcf"]= 1,
    ["particles/units/heroes/hero_terrorblade/terrorblade_ambient_sword_blade.vpcf"]= 1,
    ["particles/units/heroes/hero_terrorblade/terrorblade_ambient_sword_blade_2.vpcf"]= 1,
    ["particles/units/heroes/hero_terrorblade/terrorblade_ambient_sword_workshop_right.vpcf"]= 1,
    ["particles/units/heroes/hero_terrorblade/terrorblade_ambient_sword_workshop_left.vpcf"]= 1,
    ["particles/units/heroes/hero_terrorblade/terrorblade_metamorphosis.vpcf"]= 1,
    ["particles/units/heroes/hero_terrorblade/terrorblade_metamorphosis_transform.vpcf"]= 1,
    ["particles/units/heroes/hero_terrorblade/terrorblade_metamorphosis_base_attack.vpcf"]= 1,
    ["particles/econ/items/terrorblade/terrorblade_back_ti8/terrorblade_sunder_ti8.vpcf"]= 1,
    ["particles/econ/items/terrorblade/terrorblade_back_ti8/terrorblade_back_ambient_ti8.vpcf"]= 1,
    ["particles/econ/items/terrorblade/terrorblade_corrupted_blades/terrorblade_ambient_sword_corrupted_l.vpcf"]= 1,
    ["particles/econ/items/terrorblade/terrorblade_corrupted_blades/terrorblade_ambient_sword_blade_corrupted.vpcf"]= 1,
    ["particles/econ/items/terrorblade/terrorblade_corrupted_blades/terrorblade_ambient_sword_corrupted_r.vpcf"]= 1,
    ["particles/econ/items/terrorblade/terrorblade_corrupted_blades/terrorblade_ambient_sword_blade_corrupted_2.vpcf"]= 1,
    ["particles/econ/items/terrorblade/terrorblade_horns_arcana/terrorblade_ambient_body_arcana_horns.vpcf"]= 1,
    ["particles/econ/items/terrorblade/terrorblade_horns_arcana/terrorblade_ambient_eyes_arcana_horns.vpcf"]= 1,
    ["particles/econ/items/terrorblade/terrorblade_ti9_immortal/terrorblade_ti9_immortal_weapon.vpcf"]= 1,
    ["particles/econ/items/terrorblade/terrorblade_ti9_immortal/terrorblade_ti9_immortal_weapon_left.vpcf"]= 1,
    ["particles/econ/items/terrorblade/terrorblade_ti9_immortal/terrorblade_ti9_immortal_metamorphosis_base_attack.vpcf"]= 1,
    ["particles/econ/items/techies/techies_arcana/techies_ambient_arcana.vpcf"]= 1,
    ["particles/econ/items/techies/techies_arcana/techies_suicide_arcana.vpcf"]= 1,
    ["particles/econ/items/techies/techies_arcana/techies_remote_mine_plant_arcana.vpcf"]= 1,
    ["particles/econ/items/techies/techies_arcana/techies_remote_mines_detonate_arcana.vpcf"]= 1,
    ["particles/econ/items/techies/techies_arcana/techies_base_attack_arcana.vpcf"]= 1,
    ["particles/econ/items/witch_doctor/witch_doctor_ribbitar/witch_doctor_ribbitar_ward_attack.vpcf"]= 1,
    ["particles/econ/items/terrorblade/tb_samura_head/tb_samurai_head_ambient.vpcf"]= 1,
    ["particles/econ/items/terrorblade/tb_samurai_back/tb_samurai_back_ambient.vpcf"]= 1,
    ["particles/econ/items/terrorblade/tb_samurai_armor/tb_samurai_armor_ambient.vpcf"]= 1,
}
    ...
    if hUnit.ethereals then
        for sEtherealName, old_p_index in pairs(hUnit.ethereals) do
            if old_p_index ~= false then
                ...
                if hUnit.prismatic and Wearable:CanPrismatic(particle_name, hUnit.prismatic) then
                    ...
                    for sSubSlotName, hSubWear in pairs(hUnit.Slots) do
                        for p_name, sub_p in pairs(hSubWear["particles"]) do
                            if default_particle_name == p_name then
                                ...
                                has_old_particle = true
                                break
                            end
                        end
                    end

                    if has_old_particle then
        ...
        for _cpi, cp_table in pairs(cps) do
            if (not cp_table.style) or tostring(cp_table.style) == sStyle then
                ...
                if attach_type == "vector" then
                    ...
                    elseif (cp_table.attach_entity == "self" or cp_table.attach_entity == "self_with_wearables" )
                     and hWear and hWear["model"] 
                    then
...
function Wearable:CanPrismatic(sParticle, sPrismatic)
    if sParticle == "particles/econ/courier/courier_trail_lava/courier_trail_lava.vpcf" and sPrismatic == "unusual_red"then
        return false
    end
    return true
end
    ...
    if hUnit["prismatic_particles"] then
        for particle_name, p_table in pairs(hUnit["prismatic_particles"]) do
            if not p_table.hidden then
                ...
                if Wearable:CanPrismatic(particle_name, sPrismaticName) then
...
function Wearable:WearLike(hUnitOrigin, hUnitNew)
    local hHeroSlots = Wearable.heroes[hUnitNew.sHeroName]
    hUnitNew.Slots = {}
